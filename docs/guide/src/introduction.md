...
| [ariel](https://github.com/caliban-ai/ariel) | the chat bridge for the fleet: Discord first, then Slack and Teams. Its identity, role grants, channel configuration and audit trail are meant to be gonzalo records, and ariel stores nothing of its own. Ariel is at the design stage; the record kinds it needs are tracked in [gonzalo#277](https://github.com/caliban-ai/gonzalo/issues/277) and [#278](https://github.com/caliban-ai/gonzalo/issues/278). |
